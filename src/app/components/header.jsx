    ...
    return (
        <header className="mb-10 text-sm md:text-base">
            <div className="mt-4 flex justify-start flex-wrap">
                <div className="px-1 mr-6 mb-2 hover:underline decoration-2 bg-teal-300
                ...
                <div className="px-1 mb-2 hover:underline decoration-2 bg-teal-300
                hover:bg-teal-200 hover:shadow-md">
            ...
            <h1 className="mt-20 text-4xl hover:underline decoration-4">
                <strong><a href="/">JISHNU THAZHATH</a></strong>
            </h1>
        </header>
    );
}